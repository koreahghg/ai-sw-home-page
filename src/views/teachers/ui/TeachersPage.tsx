...
const SECTIONS = [
  { id: "booths", label: "부스 안내" },
  { id: "training", label: "교사 연수" },
  { id: "lecture", label: "미래교육 특강" },
];
  ...
  return (
    <div>
      ...
      <div className="mx-auto max-w-6xl space-y-14 px-4 py-12 sm:px-6">
        ...
        <section id="training" className="scroll-mt-32 rounded-2xl bg-gradient-to-br from-violet-500 to-violet-600 p-6 text-white sm:p-8">
        ...
        <section id="lecture" className="scroll-mt-32 rounded-2xl border border-gray-100 bg-white p-6 shadow-sm sm:p-8">
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div>
