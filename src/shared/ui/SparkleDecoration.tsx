export default function SparkleDecoration({ className = "", delay = "0s" }: { className?: string; delay?: string }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 30 30"
      className={`pointer-events-none fill-white opacity-30 [animation:float-y_5s_ease-in-out_infinite] ${className}`}
